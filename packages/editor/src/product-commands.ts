...
> = {
  ...
  "document.export-interchange": definition({
    id: "document.export-interchange",
    label: "Download Studio package",
    category: "file",
    subgroup: "export",
    keywords: ["editable", "package", "backup", "interchange", "download"],
    scope: "document",
    mutating: false,
    icon: "download",
  }),
  "document.export-figma": definition({
    id: "document.export-figma",
    label: "Export to Figma",
    category: "file",
    subgroup: "export",
    keywords: ["figma", "editable", "layers", "handoff"],
    scope: "document",
    mutating: false,
    icon: "download",
  }),
  ...
  return [
    {
      ...
      groups: [
        ...
        },
        {
          id: "export",
          items: [
            itemFor("document.export-figma", context),
            itemFor("document.export-interchange", context),
