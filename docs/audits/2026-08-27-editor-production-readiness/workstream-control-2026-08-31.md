...
| ---: | --- | --- | --- | --- | --- |
| 1 | TEXT-02 closure integration | `01a058d6-ea4b-7653-ae23-b9879054208d` | Final hardening existed as unmerged `dbb71f4`; current main contained the earlier `a116d03` repair and later mask/conformance work. | Port only the missing rich-text closure onto current main, preserve later work, pass focused checks and review, reconcile the ledgers, then merge. | merged as `f97a5a7`, `862428e` and `226118e`; independent review accepted with no P0/P1 finding |
| 2 | ASSET-02 masks M4C through M5 | `01a058d6-efa8-7332-9081-00bb8c0b40d3` | M4C C0/C1 is merged at `6265561`; C2-C5 and M5 remain. M3, M4A and M4B have named retained-evidence gaps. | Commit and accept C2-C5 and M5 without reopening M0-M2; record any healthy-host evidence blocker precisely. | C2 implemented at `fe5cc47`; C3 renderer work at `1245f4f` with checkpoint `38d7ee2`; C4-C5, M5, review and merge remain open |
| 3 | LIBRARY-02 Gate 8 | `01a058d6-f4c4-7770-9658-a68d1f702fe3` | Gates 1-6E and Gate 7 Assets workspace are merged. The existing catalog contains 21 templates and 37 media items. | Pass the complete desktop/compact, scale, workflow and independent-review closure; reconcile all library ledgers. | review HOLD after `1f3cff5`: three scale values are hardcoded and media evidence captures before decode; focused correction is in progress |
| 4 | ASSET-02 background removal B1-B4 | `01a058d6-fb14-7472-9cfa-15b9ca7d694d` | B0 durable repository and provenance contract is merged. No provider call or user workflow exists. | Accept B1 API/dispatch, B2 immutable output asset, B3 editor workflow and B4 WebMCP/evidence without unauthorized provider or cloud writes. | B1-B3 implemented at `cd530e7`, `81d644e` and `286fbf6`; B4, independent review and merge remain open |
| 5 | Full editor sophistication | `01a058d7-0b96-7bd0-8ee9-4cb5d3625209` | The bounded EDITOR-POLISH-01 Gates 1-7 were merged; full OpenPencil-level refinement remained a later product pass. | Produce and accept concrete visual/interaction gates with retained before/after evidence without changing accepted command semantics. | merged as `a55d6c5`, `6349d8e`, `df63c4c` and `b64f74d`; re-review accepted with no open P0/P1 finding |
| 6 | GEN-01 WebMCP generation | `01a058d7-17fa-76f3-84de-371e57716b6c` | Assessment and four-gate plan are merged; implementation had not started. | A supplied external `SKILL.md` can create a reviewed, editable blank or exact-template document through bounded Studio WebMCP contracts. | review HOLD after `de1d271`: public template discovery cannot yet construct every admitted node-ID operation; focused correction is in progress |
| 7 | Production evidence reconciliation | `01a058d7-0278-7d40-b1f6-53ee2f75b05e` | Local hardening is substantial; deployment and healthy-host evidence were mixed with stale migration counts and unsupported claims in older ledgers. | Produce current read-only/local truth, exact authorization checklist and safe ledger/verifier corrections without remote writes. | merged as `36bdb7d` and `85f5b73`; independent re-review accepted with no open P0/P1 finding |
