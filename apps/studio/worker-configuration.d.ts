/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a06a596e8e9a3d0d6dee7db976211ea9)
// Runtime types generated with workerd@1.20260828.1 2026-08-27 enable_request_signal,nodejs_compat,request_signal_passthrough
interface __BaseEnv_Env {
	ASSETS: R2Bucket;
	RENDERS: R2Bucket;
	DB: D1Database;
	CURATED_MEDIA: Fetcher;
	STUDIO_ACCESS_MODE: "cloudflare_access";
	ACCESS_TEAM_DOMAIN: "https://proud-poetry-8ab7.cloudflareaccess.com";
	ACCESS_POLICY_AUD: "07a8e88144f5028ff84661eb619b99821ecc076aa72be30f55cf87d7b385103b";
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "RenderAdmission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STUDIO_ACCESS_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_POLICY_AUD">> {}
}
