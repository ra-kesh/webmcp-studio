...
export const Route = createFileRoute(
  ...
  server: {
    handlers: {
      GET: ({ request, params }) =>
        handlers.getCollection(request, params.collectionId),
      PATCH: ({ request, params }) =>
        handlers.renameCollection(request, params.collectionId),
      DELETE: ({ request, params }) =>
        handlers.deleteCollection(request, params.collectionId),
    },
  },
})
