...
export const Route = createFileRoute("/v1/studio/library/collections/")({
  server: {
    handlers: {
      GET: ({ request }) => handlers.listCollections(request),
      POST: ({ request }) => handlers.createCollection(request),
    },
  },
})
