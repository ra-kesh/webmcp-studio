  ...
  return (
    <TooltipProvider delayDuration={350}>
      <div
        ...
        className={cn(
          "flex h-12 max-w-[calc(100%-1rem)] items-center gap-0.5 rounded-lg border bg-background/96 p-1 shadow-md ring-1 ring-black/3 backdrop-blur-md min-[1280px]:h-9",
          className
        )}
